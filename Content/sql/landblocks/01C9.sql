...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x701C904C, 600005, 0x01C901D1, 57.02012, -80.05438, -6.063, 0.684474, 0, 0, 0.729037, False, '2024-04-26 08:33:45'); /* Rift Entrance Portal */
/* @teleloc 0x01C901D1 [57.020119 -80.054382 -6.063000] 0.684474 0.000000 0.000000 0.729037 */
